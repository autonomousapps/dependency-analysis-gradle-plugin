...
# Compatibilities
1. Android Gradle Plugin: this plugin is built with AGP 3.6.1. It is tested to work with AGP 3.5.3, 3.6.1, 4.0.0-beta03, and 4.1.0-alpha02 (`com.android.library` and `com.android.application` projects only).
