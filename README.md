...
![Build status](https://github.com/autonomousapps/dependency-analysis-android-gradle-plugin/workflows/Test/badge.svg)
...
# Compatibilities
1. Android Gradle Plugin: this plugin is built with AGP 3.6.3. It is tested to work with AGP 3.5.3, 3.6.3, 4.0.0-beta03, and 4.1.0-alpha04 (`com.android.library` and `com.android.application` projects only).
