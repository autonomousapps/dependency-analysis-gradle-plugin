...
- [ ] All contributed code can be distributed under the terms of the
...
- [ ] Check ["Allow edit from maintainers" option](https://help.github.com/articles/allowing-changes-to-a-pull-request-branch-created-from-a-fork/) 
