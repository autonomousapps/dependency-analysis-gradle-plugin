...
image::https://img.shields.io/maven-central/v/com.autonomousapps/dependency-analysis-gradle-plugin?label=snapshot&color=orange[Latest snapshot,link="https://central.sonatype.com/service/rest/repository/browse/maven-snapshots/com/autonomousapps/dependency-analysis-gradle-plugin/"]
