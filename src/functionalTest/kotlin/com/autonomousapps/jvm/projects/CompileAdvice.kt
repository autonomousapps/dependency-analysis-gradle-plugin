...
/*
 * This file exists as a companion to CompileProject in the Groovy sourceset. Groovy gets confused
...
val expectedAdvice = listOf(
  ...
  Advice.change(COMMONS_COLLECTIONS, "api")
)