...
final class DuplicateDependencyVersionsProject extends AbstractAndroidProject {
  ...
  String expectedAllDependencies = '''\
    ...
    org-jetbrains-kotlin-kotlin-stdlib-common-2-4-0 = { module = "org.jetbrains.kotlin:kotlin-stdlib-common", version = "2.4.0" }
    ...
    org-jetbrains-kotlin-kotlin-stdlib-2-4-0 = { module = "org.jetbrains.kotlin:kotlin-stdlib", version = "2.4.0" }
  ...
  List<String> expectedResolvedDependenciesForApp(String agpVersion) {
    if (AgpVersion.version(agpVersion) >= AgpVersion.version('9.2.1')) {
      [
