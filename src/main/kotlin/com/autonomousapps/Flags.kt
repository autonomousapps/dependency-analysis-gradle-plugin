...
object Flags {
  ...
  private const val FLAG_ALLOWED_VARIANTS = "dependency.analysis.android.allowed_variants"
  private const val FLAG_IGNORED_VARIANTS = "dependency.analysis.android.ignored_variants"
  ...
  internal fun Project.getAllowedVariants() = getBuildPropForConfigurations(FLAG_ALLOWED_VARIANTS)
  internal fun Project.getIgnoredVariants() = getBuildPropForConfigurations(FLAG_IGNORED_VARIANTS)
