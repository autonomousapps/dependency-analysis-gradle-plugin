...
//   ) : Advice2(coordinates), Comparable<Simple> {
//
//     val comparator = compareBy(Simple::coordinates)
//       .thenComparing(compareBy<Simple, String?>(nullsFirst()) { it.toConfiguration })
//       .thenComparing(compareBy<Simple, String?>(nullsFirst()) { it.fromConfiguration })
//
//     override fun compareTo(other: Simple): Int = compareBy(Simple::coordinates)
//       .thenComparing(compareBy<Simple, String?>(nullsFirst()) { it.toConfiguration })
//       .thenComparing(compareBy<Simple, String?>(nullsFirst()) { it.fromConfiguration })
//       .compare(this, other)
//
...
//
//       @JvmStatic
//       fun ofRemove(coordinates: Coordinates, fromConfiguration: String) = Simple(
//         coordinates = coordinates,
//         fromConfiguration = fromConfiguration, toConfiguration = null
//       )
//
//       @JvmStatic
//       internal fun ofRemove(coordinates: Coordinates, location: Location) =
//         ofRemove(coordinates, location.configurationName)
//
//       @JvmStatic
//       fun ofChange(coordinates: Coordinates, fromConfiguration: String, toConfiguration: String) = Simple(
//         coordinates = coordinates,
...
//     /** The coordinates of the dependency that ought to be modified in some way. */
//     override val coordinates: Coordinates,
//     val fromConfigurations: Set<String>,
//     val toConfigurations: Set<String>
//   ) : Advice2(coordinates), Comparable<Complex> {
//
//     override fun compareTo(other: Complex): Int = compareBy(Complex::coordinates)
//       .compare(this, other)
//
//     companion object {
//       fun of(coordinates: Coordinates, fromConfigurations: Set<String>, toConfigurations: Set<String>) = Complex(
//         coordinates = coordinates,
//         fromConfigurations = fromConfigurations,
//         toConfigurations = toConfigurations
//       )
//     }
//   }
// }
