...
public data class PluginAdvice(
  ...
  public companion object {
    ...
    private const val LEGACY_KAPT = "com.android.legacy-kapt"
    ...
    public fun redundantKapt(): PluginAdvice = PluginAdvice(
      ...
      reason = "this project has the kotlin-kapt (org.jetbrains.kotlin.kapt) plugin applied, but there are no used annotation processors."
    )

    @JvmStatic
    public fun redundantLegacyKapt(): PluginAdvice = PluginAdvice(
      redundantPlugin = LEGACY_KAPT,
      reason = "this project has the 'com.android.legacy-kapt' plugin applied, but there are no used annotation processors."
    )
  }
}
