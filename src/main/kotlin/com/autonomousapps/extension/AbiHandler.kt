...
public abstract class ExclusionsHandler @Inject constructor(objects: ObjectFactory) {
  ...
  /**
   * Include any class into ABI analysis that is annotated with annotations that match [annotationRegexes], which means
   * those classes will be considered as part of the module's ABI.
   */
