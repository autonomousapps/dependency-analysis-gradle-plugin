...
1. `git commit -am "chore(testkit-plugin): prepare for testkit-plugin release x.y."`
...
1. `git commit -am "chore(testkit-plugin): prepare next development version of testkit-plugin."`
