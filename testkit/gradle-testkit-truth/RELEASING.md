...
1. `git commit -am "chore(testkit-truth): Prepare for testkit-truth release x.y."`
...
1. `git commit -am "chore(testkit-truth): Prepare next development version of testkit-truth."`
